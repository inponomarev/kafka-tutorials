...
+++++
<pre class="snippet"><code class="shell">{% include_raw tutorials/kstreams-average/kstreams/code/tutorial-steps/dev/console-producer.sh %}</code></pre>
+++++
...
+++++
<pre class="snippet"><code class="json">{% include_raw tutorials/kstreams-average/kstreams/code/tutorial-steps/dev/INPUT_DATA.json %}</code></pre>
+++++

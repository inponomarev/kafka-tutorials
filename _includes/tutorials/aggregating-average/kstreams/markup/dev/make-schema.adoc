////
  ...
  _includes/tutorials/kstreams-average/kstreams/code/src/main/avro.
...
+++++
<pre class="snippet"><code class="avro">{% include_raw tutorials/kstreams-average/kstreams/code/src/main/avro/movie.avsc %}</code></pre>
+++++
